...
class StudentListRecyclerAdapterRealm(private val data: List<StudentRealm>, private var onClickListener: OnClickListener?) : RecyclerView.Adapter<StudentListRecyclerAdapterRealm.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: StudentRealm)
    }
